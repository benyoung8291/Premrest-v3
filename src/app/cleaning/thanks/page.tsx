            ...
            <div class="grid_wrapper">
              <div class="grid-1-column">
                <div class="grid-column"><img src="../images/contact-image.svg" alt="" class="utility-page_image">
                  <h1 id="w-node-e5689b5c-cef6-c819-dc6f-6792b0de995b-948ccf09" class="_404-heading">Thanks, you're all set.</h1>
                  <div id="w-node-e5689b5c-cef6-c819-dc6f-6792b0de995d-948ccf09" class="_404-text">Our team will respond to your enquiry before the dust settles.</div>
                  <a id="w-node-e5689b5c-cef6-c819-dc6f-6792b0de995f-948ccf09" href="/../index" class="button _404-button w-button">Go back home</a>
                </div>
              </div>
            </div>
          </div>
