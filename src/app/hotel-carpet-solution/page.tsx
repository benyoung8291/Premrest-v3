...
.padding-vertical {
  ...
  padding-left: 0rem !important;
    ...
    <div class="main-wrapper">
      <div class="hotel-carpet-section-hero background-color-cream hero-padding-top">
              ...
              <div class="grid-2-columns">
                <div class="grid-column">
                  <div class="hero-heading-block">
                    <h1 data-w-id="8a5b2e3c-c577-5343-879f-9d3f5576a813" style="opacity:0" class="hero-headline hotel-carpet-hero-headline">Stop Disruptions and Costly Repairs </h1><img src="/images/Premrest_Lines_Tan.svg" loading="lazy" style="opacity:0" data-w-id="ae9a098d-979e-7278-b63b-e63f82eff2e4" alt="" class="hotel-carpet-hero-patches">
                  </div>
                  <p data-w-id="be180c40-798e-c982-98b0-f0b61a6a24c3" style="opacity:0" class="text-size-large hotel-carpet-hero-subheadline">When a single stain or tear forces room closures and expensive, all-or-nothing repairs, your budget and guest experience suffer.<br><br>Get the luxurious, plush feel of broadloom with the convenience and flexibility of modular carpet.</p>
                  <a data-w-id="32881dfd-b184-4904-6d82-ca84f3165491" style="opacity:0" href="#hotel-carpet-form" class="button w-button">Let's chat</a>
                </div>
                <div id="w-node-_5ab817d8-e59e-8435-7456-975a1331faea-3516d5d6" class="grid-column grid-column-inverse">
                  <div id="w-node-_5601d830-bb0c-32df-ce66-920f9dc42bca-3516d5d6" class="column-image-block"><img src="/images/hotel-carpet.png" loading="lazy" alt="" class="hero-image hero-image-hotel-carpet"><img src="/images/Premrest_Scribble_Green.svg" loading="lazy" alt="" class="hotel-carpet-hero-image-scribble"><img src="/images/Premrest_Patch_Orange.svg" loading="lazy" alt="" class="hotel-carpet-hero-image-patch"></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="hotel-carpet-section-problem">
        <div class="padding-global padding-section-large">
          <div class="container-large">
            <div class="grid-wrapper">
              <div class="grid-2-columns">
                <div class="grid-column">
                  <div id="w-node-d46871d1-599c-2295-8068-a9a5f68c2562-3516d5d6" class="column-image-block"><img src="/images/Premrest_HotelCarpet_Problem_Blob.webp" loading="lazy" alt="" class="section-image"></div>
                </div>
                <div class="grid-column"><img src="/images/Premrest_DirtyShoe_Charcoal.svg" loading="lazy" alt="" class="hotel-carpet-problem-shoe">
                  <h2>Maintaining beautiful rooms without costly, disruptive repairs is challenging.</h2>
                  <p>Broadloom carpet turns small damage into big disruptions. A single stain or tear can shut down rooms, cut into revenue, and undermine the guest experience you work hard to create. Repairs drag on, replacements bring even bigger headaches, and before you know it, maintenance feels like a never-ending battle.<br>‍<br>And, the costs stack up fast. <br><br>Instead of simple, targeted fixes, you’re stuck with expensive, 'all-or-nothing' solutions that drain your budget. Fixing broadloom means tearing up large sections, wasting materials, and paying for intensive repairs - for something so trivial.<br>‍<br>Even after repairs, the results fall short. Patches stand out, mismatched sections disrupt the design, and the flawless look guests expect starts to fade. Without a simple, phased approach, you’re left with costly, large-scale renovations instead of a seamless, stress-free update.</p>
                  <a href="#hotel-carpet-form" class="button w-button">Let's chat</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="hotel-carpet-section-solution">
        <div class="padding-global padding-section-large padding-section-large-bottom">
          <div class="container-large">
            <div class="grid-wrapper">
              <div class="grid-2-columns">
                <div class="grid-column">
                  <h2>A seamless, innovative carpet tile: with the benefits of broadloom.</h2>
                  <p>With modular carpet, damage is no longer a disaster. Instead of shutting down entire rooms, you can replace only what’s needed, in minutes - not days.<br><br> That’s why we’ve developed an innovative carpet tile solution designed specifically for hotels. Plush and soft underfoot, it offers the luxurious feel of broadloom with the practical benefits of modular designgiving you a smarter, more efficient way to maintain beautiful floors.<br><br>No more waste, no more unnecessary costs, just seamless repairs that blend perfectly with the surrounding carpet:<br></p>
                  <div class="w-richtext">
                    <ul role="list">
                      <li><strong>Minimised Disruption:</strong> Replace only the damaged tiles - no need for full room closures.</li>
                      <li>‍<strong>Enhanced Durability:</strong> Our solution-dyed nylon ensures superior stain resistance.</li>
                      <li>‍<strong>Long-Term Confidence:</strong> Backed by a 15-year warranty from the manufacturer.</li>
                    </ul>
                    <p>‍</p>
                    <p>We offer flexible pricing options to suit your needs:</p>
                    <p>‍</p>
                    <ul role="list">
                      <li><strong>Per-Room Pricing &amp; Phased Rollout:</strong> Update rooms gradually.</li>
                      <li>‍<strong>Full Rollout:</strong> Secure our best volume-based pricing.</li>
                    </ul>
                  </div>
                  <a href="#hotel-carpet-form" class="button w-button">Let's chat</a>
                </div>
                <div id="w-node-_994dd22b-9209-4e90-5ec7-9da0ddc370d0-3516d5d6" class="grid-column"><img src="/images/Premrest_Cleaning_Steps_Blob.png" loading="lazy" alt="" class="section-image"></div>
              </div>
            </div>
          </div>
        </div>
      </div>
      <div class="hotel-carpet-section-final">
        <div class="padding-global padding-section-large">
          <div class="container-large">
            <div class="grid-wrapper">
              <div class="grid-2-columns">
                <div id="w-node-_5393c0cf-5421-f38d-8e5e-67f3871b0c0a-3516d5d6" class="grid-column grid-column-1">
                  <h2 id="w-node-_5393c0cf-5421-f38d-8e5e-67f3871b0c0b-3516d5d6" class="text-light hotel-carpet-final-headline">Targeted fixes.<br>Zero disruptions.<br>Better hotel experience.</h2>
                </div>
                <div id="w-node-b3cf76f3-9e09-fc31-ce87-0dbbd00ec4cd-3516d5d6" class="grid-column-form">
                  <div class="form-container">
                    <div id="hotel-carpet" class="w-form">
                      <form id="hotel-carpet-form" name="wf-form-Hotel-Carpet-Form" data-name="Hotel Carpet Form" method="get" data-wf-page-id="67ad5c483a8bd0163516d5d6" data-wf-element-id="b3cf76f3-9e09-fc31-ce87-0dbbd00ec4d0">
                        <div class="form-block-2-columns">
                          <div class="form-block-grid-column"><label for="First-Name-Hotel-Carpet" class="form-label">First name</label><input class="form-field w-input" maxlength="256" name="First-name" data-name="First name" placeholder="" type="text" id="First-Name-Hotel-Carpet" required=""></div>
                          <div class="form-block-grid-column"><label for="Last-Name-Hotel-Carpet" class="form-label">Last name</label><input class="form-field w-input" maxlength="256" name="Last-name" data-name="Last name" placeholder="" type="text" id="Last-Name-Hotel-Carpet" required=""></div>
                        </div>
                        <div class="form-block-2-columns">
                          <div class="form-block-grid-column"><label for="Email-Address-Hotel-Carpet" class="form-label">Email address</label><input class="form-field w-input" maxlength="256" name="Email-address" data-name="Email address" placeholder="" type="email" id="Email-Address-Hotel-Carpet" required=""></div>
                          <div class="form-block-grid-column"><label for="Phone-Number-Hotel-Carpet" class="form-label">Phone number</label><input class="form-field w-input" maxlength="256" name="Phone-number" data-name="Phone number" placeholder="" type="tel" id="Phone-Number-Hotel-Carpet"></div>
                        </div><label for="Hotel-name" class="form-label">Hotel name</label><input class="form-field w-input" maxlength="256" name="Hotel-name" data-name="Hotel name" placeholder="" type="text" id="Hotel-name" required="">
