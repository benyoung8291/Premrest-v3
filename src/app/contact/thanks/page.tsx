...
.padding-vertical {
  ...
  padding-left: 0rem !important;
    ...
    <div class="main-wrapper">
      <section class="thanks-section-hero">
            ...
            <div class="grid_wrapper">
              <div class="grid-1-column">
                <div class="grid-column"><img src="../images/contact-image.svg" alt="" class="utility-page_image">
                  <h1 id="w-node-_1399e347-09ed-a546-19bf-41c53a1694e6-b1aa34ac" class="_404-heading">Thanks, you're all set.</h1>
                  <div id="w-node-_1399e347-09ed-a546-19bf-41c53a1694e8-b1aa34ac" class="_404-text">Our team will respond to your enquiry before the dust settles.</div>
                  <a id="w-node-_1399e347-09ed-a546-19bf-41c53a1694ea-b1aa34ac" href="/../index" class="button _404-button w-button">Go back home</a>
                </div>
              </div>
            </div>
          </div>
