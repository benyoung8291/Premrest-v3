  ...
  const slots = {
    ltsLatest: (
      <PodcastLatestEpisode
        tagSlug="lets-talk-sustainability"
        headlineClass="lts-latestepisode-headline"
        textClass="lts-latestepisode-text"
        badgeModifier="is-cream"
        badgeTextModifier="is-orange"
      />
    ),
    ltsEpisodes: <PodcastEpisodesGrid tagSlug="lets-talk-sustainability" />,
  };
