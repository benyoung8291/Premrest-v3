...
.padding-vertical {
  ...
  padding-left: 0rem !important;
    ...
    <main class="main-wrapper">
      <section class="sdsdatasheets_section_hero">
        <div class="padding-global padding-section-large">
          <div class="container-xlarge">
            <div class="grid_wrapper">
              <div class="w-embed w-iframe"><iframe class="airtable-embed" src="https://airtable.com/embed/appAJdUNw8P3WkYmo/shr2gf9Uf8JPGq6nK" frameborder="0" onmousewheel="" width="100%" height="3000" style="background: transparent; border: 1px solid #ccc;"></iframe></div>
            </div>
          </div>
        </div>
      </section>
