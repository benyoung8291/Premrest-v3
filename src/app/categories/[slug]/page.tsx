...
export const metadata: Metadata = {
  title: "Premrest | Commercial Floor Resources",
  openGraph: {
    title: "Premrest | Commercial Floor  Resources"
  },
  twitter: {
          ...
          <div class="container-xlarge">
            <div class="grid-wrapper">
              <div class="grid-1-column">
                <div id="w-node-_85d1b34a-0d65-84e6-7bfb-3345106cd30d-821b30c6" class="grid-column">
                  <h1 id="w-node-_85d1b34a-0d65-84e6-7bfb-3345106cd30e-821b30c6" class="heading-style-h2 header-heading w-dyn-bind-empty"></h1>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="container-large">
            <div class="grid-wrapper">
              <div fs-cmsfilter-element="list" class="collection-list-wrapper w-dyn-list">
                <div fs-cmsfilter-field="contents" role="list" class="category-resources-collection w-dyn-items">
